...
public class TitleUtils {
	...
	private static void sendPacket(Player player, Object packet)
			throws Exception {
		final Object handle = player.getClass()
				.getMethod("getHandle", new Class[0])
				.invoke(player, new Object[0]);
		final Object playerConnection = handle.getClass()
	...
	public static void sendTitle(Player player, String title, String subtitle,
			int fadeIn, int stay, int fadeOut) {
		try {
			final Object enumTitle = getNMSClass("PacketPlayOutTitle")
					.getDeclaredClasses()[0].getField("TITLE").get(null);
			final Object titleChat = getNMSClass("IChatBaseComponent")
					.getDeclaredClasses()[0].getMethod("a",
					new Class[] { String.class }).invoke(null,
					new Object[] { "{\"text\":\"" + title + "\"}" });
			final Object enumSubtitle = getNMSClass("PacketPlayOutTitle")
					.getDeclaredClasses()[0].getField("SUBTITLE").get(null);
			final Object subtitleChat = getNMSClass("IChatBaseComponent")
					.getDeclaredClasses()[0].getMethod("a",
					new Class[] { String.class }).invoke(null,
					new Object[] { "{\"text\":\"" + subtitle + "\"}" });
			final Constructor<?> titleConstructor = getNMSClass(
			...
			final Object titlePacket = titleConstructor
					.newInstance(new Object[] { enumTitle, titleChat,
							Integer.valueOf(fadeIn), Integer.valueOf(stay),
							Integer.valueOf(fadeOut) });
			final Object subtitlePacket = titleConstructor
					.newInstance(new Object[] { enumSubtitle, subtitleChat,
							Integer.valueOf(fadeIn), Integer.valueOf(stay),
							Integer.valueOf(fadeOut) });
