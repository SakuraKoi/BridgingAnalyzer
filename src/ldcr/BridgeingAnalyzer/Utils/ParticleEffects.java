...
public enum ParticleEffects {
	...
	public static final class ParticlePacket {
		...
		public ParticlePacket(final ParticleEffects effect,
				final ParticleEffects.ParticleColor color,
				final boolean longDistance) {
		...
		public ParticlePacket(final ParticleEffects effect,
				final Vector direction, final float speed,
				final boolean longDistance,
				final ParticleEffects.ParticleData data)
				throws IllegalArgumentException {
	...
	public static ParticleEffects fromId(final int id) {
		for (final Map.Entry<Integer, ParticleEffects> entry : ID_MAP
				.entrySet()) {
	...
	public static ParticleEffects fromName(final String name) {
		for (final Map.Entry<String, ParticleEffects> entry : NAME_MAP
				.entrySet()) {
	...
	private ParticleEffects(final String name, final int id,
			final int requiredVersion, final ParticleProperty... properties) {
		this.name = name;
		this.id = id;
	...
	public void display(final float offsetX, final float offsetY,
	...
	public void display(final int amount, final Location center,
			final double range)
			throws ParticleEffects.ParticleVersionException,
			ParticleEffects.ParticleDataException, IllegalArgumentException {
